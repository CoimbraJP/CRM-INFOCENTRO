...
export function TemplatesProvider({ children }) {
  ...
  // percorre as chaves do OVERRIDE (não só as do DEFAULTS), senão estratégias criadas pelo
  // usuário (tipo "custom_...", que não existem em DEFAULTS) nunca apareciam salvas.
  const templates = { ...DEFAULTS };
  for (const tipo of Object.keys(overrides)) {
