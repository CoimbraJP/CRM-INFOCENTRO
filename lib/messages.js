...
export const TEMPLATES = {
  ...
  POS7: {
    titulo: "Pós-conserto — D+7",
    variacoes: [
      "Oi {nome}! Aqui é da INFO Centro 😊 Faz uma semana que você retirou seu equipamento — está tudo funcionando direitinho? Qualquer coisa é só chamar, estamos à disposição. 🔧",
      "{nome}, tudo bem? INFO Centro por aqui! Passando pra saber se o equipamento está funcionando 100% depois do serviço. Se notar qualquer coisa estranha, me chama que resolvemos rapidinho. 🙂"
    ]
  },
  POS90: {
    titulo: "Pós-conserto — D+90 (revisão preventiva)",
    variacoes: [
      "Oi {nome}! Aqui é da INFO Centro. Já se passaram 3 meses do seu conserto — que tal uma revisão preventiva? Limpeza e checagem geral evitam surpresa e alongam a vida do equipamento. Se quiser, é só chamar pra agendar! 🔧",
      "{nome}, tudo certo? INFO Centro aqui 😊 Seu equipamento passou pela gente há uns 3 meses — uma manutenção preventiva agora sai muito mais barato que um conserto depois. Quer agendar uma revisão? É rapidinho!"
    ]
  }
};
...
export const STRATEGY_META = [
  ...
  { tipo: "POS7", titulo: "Pós-conserto", subtitulo: "D+7 · após OS entregue", icone: "wrench", habilitado: true },
  { tipo: "POS90", titulo: "Revisão preventiva", subtitulo: "D+90 · após OS entregue", icone: "clock", habilitado: true },
];
